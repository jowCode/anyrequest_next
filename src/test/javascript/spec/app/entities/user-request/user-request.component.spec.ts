...
import { UserRequestComponent } from 'app/entities/user-request/user-request.component';
...
describe('Component Tests', () => {
  describe('UserRequest Management Component', () => {
    let comp: UserRequestComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserRequestComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userRequests && comp.userRequests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
